...
<!-- 		<view class="group-profile">
			<TUI-group-profile v-if="isShow" id="groip-profile" 
			:conversation="conversation" />
		</view> -->
		<!-- 消息列表 -->
		<view class="message-list" @tap="triggerClose">
			<TUI-message-list id="message-list" 
			ref="messageList" :conversation="conversation" />
		</view>
		<!-- 视频 -->
		...
		<view v-if="showChat" class="message-input ">
			<TUI-message-input id="message-input" ref="messageInput" 
			:conversation="conversation" @sendMessage="sendMessage" />
		</view>
...
import TUIMessageList from '@/pages_message/components/tui-chat/message-list/index';
// import TUIMessageInput from '../../components/tui-chat/message-input/index';
import TUIMessageInput from '@/pages_message/components/tui-chat/message-input/index';
// import TUIGroupProfile from '../../components/tui-group/group-profile/index';
// import TUIGroupProfile from '@/pages_message/components/tui-group/group-profile/index';
...
export default {
	...
	created() {
		...
		uni.$TUIKit
			.updateMyProfile({
				avatar: this.vuex_user.headPortrait,
